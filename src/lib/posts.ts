...
/** Get active driver posts for an area, pruning expired index entries */
...
/** Get active rider posts for an area, pruning expired index entries */
 ...
 * Matches on vehicle type, seat capacity, and overlapping price range.
 */
