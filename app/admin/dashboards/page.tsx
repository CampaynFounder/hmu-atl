// /admin/dashboards — list of all dashboards (super only).
//
// Route-permissions enforces super in app/admin/layout.tsx, so we can SQL
// directly without per-row gating. Builtins listed first, then user-built.
