...
export const ADMIN_SEARCH_MANIFEST: AdminSearchItem[] = [
  ...
  },
  {
    id: 'rider-growth',
    label: 'Rider Growth',
    description: 'Rider-acquisition SMS inbox on the 2nd line',
    href: '/admin/rider-growth',
    section: 'Grow',
    icon: '📈',
    keywords: ['rider growth', 'acquisition', 'sms', 'inbox', 'second line', 'voip', 'texts', 'leads', 'outreach', 'signups'],
  },
  {
    id: 'booking-types',
    label: 'Booking Types',
    description: 'Per-market on/off for direct, blast, down bad, delivery',
    href: '/admin/booking-types',
    section: 'System',
    icon: '🎚️',
    keywords: ['booking types', 'rollout', 'kill switch', 'direct', 'blast', 'down bad', 'delivery', 'enable', 'disable', 'per market', 'toggle', 'launch'],
  },
  {
    id: 'outreach',
    label: 'Outreach',
