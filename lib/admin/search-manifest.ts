...
export const ADMIN_SEARCH_MANIFEST: AdminSearchItem[] = [
  ...
  {
    id: 'flows-rider',
    label: 'Rider — Standard Sign-up Flow',
    description: 'RiderOnboarding + FirstTimePaymentBlocker walkthrough',
    href: '/admin/flows/rider',
    section: 'Tools',
    icon: '🙋',
    permission: 'tools.flows',
    keywords: ['rider onboarding preview', 'first time payment', 'rider signup', 'training rider', 'card link'],
  },
  {
