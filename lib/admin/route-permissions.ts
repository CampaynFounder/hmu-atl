...
export const ADMIN_ROUTES: AdminRouteEntry[] = [
  ...
  { pattern: '/admin/push',                rule: { kind: 'permission', slug: 'act.notifications' } }, // send a marketing/announcement push to one user
  ...
  { pattern: '/admin/demo-accounts',       rule: { kind: 'super' } }, // provision demo accounts + OTP bypass codes — super only
  { pattern: '/admin/admin-alerts',        rule: { kind: 'super' } }, // super-admin push alert toggles — super only
